<?php
/**
 * Tudor SEO Portfolio Theme functions and definitions
 */
...
function tudorseo_scripts() {
    wp_enqueue_style('tudorseo-style', get_stylesheet_uri());
    wp_enqueue_script('tudorseo-script', get_template_directory_uri() . '/assets/js/script.js', array(), '1.0', true);
}
